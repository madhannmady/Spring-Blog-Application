...
import com.madhankumar.blog.repositories.PostRepository;
import com.madhankumar.blog.services.CategoryService;
import com.madhankumar.blog.services.PostService;
import com.madhankumar.blog.services.TagService;
...
public class PostServiceImp implements PostService {
    ...
    public Post getPost(UUID id) {
        return postRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("Post doesn't exist this id: "+id));
    }
